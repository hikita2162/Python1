from Lesson_7_2.sweg_Labs.Pages.LoginPage import LoginPage
from Lesson_7_2.sweg_Labs.Pages.ProductsPage import ProductsPage
from Lesson_7_2.sweg_Labs.Pages.CheckoutPage import CheckoutPage
